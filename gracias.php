...
<main>
  <section class="bg-contacto bg-blue-light d-flex align-items-center" style="min-height: 80vh;">
    <div class="container">
      <div class="row align-items-center justify-content-center text-center">
        <div class="col-10 col-lg-8">
          <h1 class="kento fw-400 text-white mb-4">¡Gracias por contactarte con nosotros!</h1>
          <p class="text-white font20">Nos estaremos comunicando con vos a la brevedad.</p>
          <div class="mt-5">
            <a href="index.php" class="btn btn-light fw-500 font14 blue-light py-2 rounded-3 px-5">Volver al inicio</a>
          </div>
        </div>
      </div>
    </div>
