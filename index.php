...
<!-- HEADER -->
<header id="main-header" class="position-fixed w-100 top-0 start-0 index-9">
  <nav class="navbar navbar-expand-lg">
    <div class="container">
      
      <!-- LOGO (Siempre visible) -->
      <a class="navbar-brand" href="index.php">
        <img src="img/logo.svg" alt="Monoplast" width="120"> <!-- Asegura un width para evitar saltos -->
      </a>

      <!-- BOTÓN HAMBURGUESA (Móvil) -->
      <!-- Le agregamos border-0 para que se vea más limpio -->
      <button class="navbar-toggler border-0" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent">
        <!-- Usamos un ícono blanco o con filtro si el fondo es azul -->
        <span class="navbar-toggler-icon" style="filter: invert(1);"></span> 
      </button>

      <!-- CONTENIDO DEL MENÚ (Links + Buscador + Carrito) -->
      <div class="collapse navbar-collapse justify-content-between" id="navbarSupportedContent">
        ...
        <!-- ÁREA DERECHA: BUSCADOR Y CARRITO -->
        <!-- La clase d-flex organiza esto en fila en escritorio, y columna en móvil si queremos -->
        <div class="d-flex align-items-center justify-content-center gap-3 mt-3 mt-lg-0">
            
            <!-- BUSCADOR -->
            <div class="search-box position-relative d-flex align-items-center rounded-pill px-2 py-1">
            ...
            <!-- CARRITO CON BADGE -->
            <!-- 'position-relative' es clave para posicionar el numerito -->
            <a class="position-relative d-inline-block" data-bs-toggle="offcanvas" data-bs-target="#offcanvasWithBothOptions" style="cursor: pointer;">
    ...
    <div class="container">
      <div class="row gx-5">
        ...
        <div class="col-10 offset-1 offset-md-0 col-md-6 py-5">
          ...
          <h2 class="mb-md-5 mb-4 mt-4">Conocé todo lo que <br>tenemos para tu proyecto</h2>
