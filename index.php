...
<body>
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mx-auto mb-2 mb-lg-0 px-4">
          ...
          <li class="nav-item">
            <a class="nav-link" href="https://sanitariosmunro.mercadoshops.com.ar/" target="_blank">Mercado Shops</a>
          </li>
          <li class="nav-item">
    ...
    <div class="swiper mySwiper">
      <div class="swiper-wrapper">
        <div class="swiper-slide bg-slide-1">
          <div class="content container h-100 d-flex flex-column align-items-end justify-content-center text-start">
            <h1 class="mb-0">Llegó la <br>temporada de pileta</h1>
          </div>
        </div>
        <div class="swiper-slide bg-slide-2">
          <div class="content container h-100 d-flex flex-column align-items-end justify-content-center text-start">
            <h1 class="mb-0">Más de 40 años <br>acompañando tus obras</h1>
          </div>
        </div>
        <div class="swiper-slide bg-slide-3">
          <div class="content container h-100 d-flex flex-column align-items-end justify-content-center text-start">
            <h1 class="mb-0">Nuestras <br>mamparas</h1>
          </div>
        </div>
      </div>
  ...
  <section class="py-5 buscados">
    <div class="container">
      <div class="row">
        <div class="col-12 border-bottom border-blue mb-4">
    ...
    <div class="container">
      <div class="row gx-5">
        ...
        <div class="col-12 col-md-6 py-5">
          ...
          <h2 class="mb-5 mt-4">Conocé todo lo que <br>tenemos para tu proyecto</h2>
          ...
          <button type="button" class="btn btn-light fw-500 font14 blue rounded-5 px-4">Ver todos los productos</button>
        </div>
      </div>
    </div>
  </section>
        ...
        <div class="col-12">
          <div class="swiper slideServicios">
            <div class="swiper-wrapper mb-5">
              ...
              <div class="swiper-slide text-start">
                <div class="bg-servicio bg-servicio4"><div class="d-flex align-items-center justify-content-center h-100 position-absolute w-100 index-9"><img src="img/icono-pieza.svg" height="95"></div></div>
